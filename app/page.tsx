...
export default function Home() {
  ...
  const milestone1Media = [
    { type: 'image' as const, src: '/milestones/milestone-1/AdminB2C-MisOfertas-dektop-1.png', device: 'none' as const, alt: 'Admin B2C Desktop - Mis Ofertas' },
    { type: 'image' as const, src: '/milestones/milestone-1/AdminB2C-MiPerfil-Mobile-1.png', device: 'none' as const, alt: 'Admin B2C Mobile - Mi Perfil' },
  ]

  // Milestones 2-6 use mockups (placeholder - same images with device frames)
  const milestoneMediaWithMockups = [
    { type: 'image' as const, src: '/milestones/milestone-1/AdminB2C-MisOfertas-dektop-1.png', device: 'macbook' as const, alt: 'Admin B2C Desktop - Mis Ofertas' },
    { type: 'image' as const, src: '/milestones/milestone-1/AdminB2C-MiPerfil-Mobile-1.png', device: 'iphone' as const, alt: 'Admin B2C Mobile - Mi Perfil' },
  ]
